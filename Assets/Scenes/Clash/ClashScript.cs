...
public class ClashScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        player1 = new ClashPlayer("5,6,9,14,3,12,11,7,17,19,4,15,10,16,20,13,8,18");
        player2 = new ClashPlayer("23,30,21,35,31,22,32,25,28,24,33,34,26,36,27,37,29");
        // set animationQueue
        // clashAnimationQueue = new ClashAnimationQueue("");
        clashAnimationQueue = new ClashAnimationQueue("p,dws,1,0*p,p,1,0*p,pow,3,1*s,dws,1,0*s,p,1,0*p,dws,1,0*p,p,2,0*p,pow,1,1*p,pow,1,2*s,dws,1,0*s,p,2,0*p,dws,1,0*p,p,3,0*s,dws,1,0*s,p,3,0*p,dws,1,0*p,pow,1,1*p,p,4,0*p,pow,-1,1*s,dws,1,0*s,p,4,0*p,dws,1,0*p,pow,1,1*p,p,5,0*p,pow,1,5*s,dws,1,0*s,p,5,0*p,dws,1,0*p,pow,1,1*p,p,6,0*s,dws,1,0*s,p,6,0*s,pow,2,5*b,r,1,2*p,dws,1,0*p,pow,1,2*p,p,1,0*s,pow,1,1*s,pow,1,3*s,pow,1,4*s,pow,1,5*s,pow,1,6*b,gd,0,1*b,r,3,6*s,pow,1,1*s,pow,1,3*s,pow,1,4*s,pow,1,5*s,dws,1,0*s,p,6,0*s,pow,1,1*s,pow,1,6*b,gd,1,0*b,r,3,1*p,dws,1,0*p,p,4,0*p,dws,1,0*p,uns,1,0*s,pow,1,3*s,pow,1,4*s,pow,1,5*s,pow,1,6*b,gd,0,1*b,r,6,2*p,dws,1,0*p,uns,1,0*p,dws,1,0*p,uns,1,0*p,dws,1,0*p,uns,1,0*s,pow,1,4*s,pow,1,5*s,pow,1,6*s,dws,1,0*s,p,3,0*b,gd,1,0*b,r,3,1*s,pow,1,4*s,pow,1,5*s,pow,1,6*s,dws,1,0*s,p,3,0*b,gd,1,0*b,r,4,1*p,dws,1,0*p,p,5,0*s,pow,1,4*s,pow,1,5*s,pow,1,6*b,gd,0,1*b,r,6,4*s,pow,1,5*s,pow,1,6*s,dws,1,0*s,p,4,0*b,gd,1,0*b,r,5,2*s,pow,1,5*s,pow,1,6*s,dws,1,0*s,p,4,0*b,gd,1,0*b,r,4,1*s,pow,1,5*s,pow,1,6*b,gd,1,1*s,2w,0,0");
        //
