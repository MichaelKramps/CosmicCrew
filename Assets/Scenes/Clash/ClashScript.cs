...
public class ClashScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        player1 = new ClashPlayer("19,13,17,18,20,14,9,12,16");
        player2 = new ClashPlayer("20,20,16,18,17,20,20,15,19,20");
        // set animationQueue
        // clashAnimationQueue = new ClashAnimationQueue("");
        clashAnimationQueue = new ClashAnimationQueue("p,dws,1,0*p,p,1,0*p,dws,1,0*p,uns,1,0*s,dws,1,0*s,uns,1,0*s,dws,1,0*s,p,1,0*p,dws,1,0*s,pow,1,1*s,pow,1,1*p,p,2,0*s,dws,1,0*s,p,2,0*p,dws,1,0*s,pow,1,1*s,pow,1,2*p,p,3,0*s,dws,1,0*s,p,3,0*p,dws,1,0*s,pow,1,1*s,pow,1,3*p,p,4,0*s,dws,1,0*p,pow,1,1*p,pow,1,4*s,p,4,0*p,dws,1,0*s,pow,1,1*s,pow,1,4*p,p,5,0*p,pow,-1,1*s,dws,1,0*p,pow,1,1*p,pow,1,5*s,p,5,0*p,dws,1,0*s,pow,1,1*s,pow,1,5*s,pow,1,1*s,pow,1,5*p,p,6,0*s,dws,1,0*p,pow,1,1*p,pow,1,6*s,p,6,0*b,r,5,6*b,g1,5,6*p,dws,1,0*p,pow,1,1*s,pow,1,1*s,pow,1,5*s,pow,1,1*s,pow,1,5*p,uns,1,0*p,dws,1,0*p,pow,1,1*s,pow,1,1*s,pow,1,5*s,pow,1,1*s,pow,1,5*p,p,5,0*s,dws,1,0*p,pow,1,1*p,pow,1,6*s,uns,1,0*b,r,6,2*b,g2,6,2*p,dws,1,0*s,pow,1,1*s,pow,1,5*s,pow,1,1*s,pow,1,5*p,uns,1,0*s,dws,1,0*p,pow,1,1*p,pow,1,5*s,uns,1,0*s,dws,1,0*p,pow,1,1*p,pow,1,5*s,p,2,0*b,r,4,4*b,g1,4,4*p,dws,1,0*s,pow,1,1*s,pow,1,5*s,pow,1,1*s,pow,1,5*s,pow,1,1*s,pow,1,5*p,uns,1,0*p,dws,1,0*s,pow,1,1*s,pow,1,5*s,pow,1,1*s,pow,1,5*s,pow,1,1*s,pow,1,5*p,p,4,0*s,dws,1,0*s,uns,1,0*b,r,5,2*b,g1,5,2*p,dws,1,0*s,pow,1,1*s,pow,1,5*s,pow,1,1*s,pow,1,5*p,uns,1,0*p,dws,1,0*s,pow,1,1*s,pow,1,5*s,pow,1,1*s,pow,1,5*p,p,5,0*s,dws,1,0*p,pow,1,1*p,pow,1,5*s,uns,1,0*b,r,3,5*b,g2,3,5*s,dws,1,0*p,pow,1,1*p,pow,1,5*s,uns,1,0*s,dws,1,0*p,pow,1,1*p,pow,1,5*s,p,5,0*s,dws,1,0*p,pow,1,1*p,pow,1,5*s,uns,1,0*p,dws,1,0*s,pow,1,1*s,pow,1,5*p,uns,1,0*b,r,3,2*b,gt,3,2*p,dws,1,0*s,pow,1,1*s,pow,1,5*p,uns,1,0*p,dws,1,0*s,pow,1,1*s,pow,1,5*p,uns,1,0*p,dws,1,0*s,pow,1,1*s,pow,1,5*p,uns,1,0*b,r,4,1*b,g2,4,1*s,dws,1,0*s,p,1,0*s,dws,1,0*s,pow,3,1*s,uns,1,0*b,r,3,4*b,g1,3,4*p,dws,1,0*p,p,1,0*b,r,3,5*b,g2,3,5*s,dws,1,0*s,p,1,0*b,r,2,2*b,g2,2,2*s,dws,1,0*s,p,1,0*s,2w,0,0");
        //
