...
public class ClashScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        player1 = new ClashPlayer("18,9,10,20,18,8,20,10,8,9");
        player2 = new ClashPlayer("34,29,29,30,30,31,31,34");
        // set animationQueue
        // clashAnimationQueue = new ClashAnimationQueue("");
        clashAnimationQueue = new ClashAnimationQueue("p,dws,1,0*p,p,1,0*s,dws,1,0*s,p,1,0*p,dws,1,0*p,p,2,0*s,dws,1,0*s,p,2,0*p,dws,1,0*p,pow,1,1*p,p,3,0*s,dws,1,0*s,p,3,0*p,dws,1,0*p,pow,1,1*p,p,4,0*s,dws,1,0*p,pow,1,1*p,pow,1,4*s,p,4,0*p,dws,1,0*p,pow,1,1*p,p,5,0*s,dws,1,0*p,pow,1,1*p,pow,1,5*s,p,5,0*p,dws,1,0*p,pow,1,1*p,p,6,0*s,dws,1,0*p,pow,1,1*p,pow,1,6*s,p,6,0*b,r,2,1*p,dws,1,0*p,pow,1,6*p,uns,1,0*p,dws,1,0*p,pow,1,6*p,p,2,0*s,pow,1,2*s,pow,1,3*s,pow,1,3*s,pow,1,2*s,pow,1,4*s,pow,1,2*s,pow,1,3*s,pow,1,5*s,pow,1,2*s,pow,1,3*s,pow,1,6*s,pow,1,2*s,pow,1,3*s,dws,1,0*p,pow,1,1*p,pow,1,6*s,p,1,0*b,gd,1,0*b,r,1,2*p,dws,1,0*p,pow,1,6*p,uns,1,0*p,dws,1,0*p,pow,1,6*p,p,1,0*s,pow,1,1*s,pow,1,3*s,pow,1,3*s,pow,1,4*s,pow,1,3*s,pow,1,5*s,pow,1,3*s,pow,1,6*s,pow,1,3*s,pow,1,1*s,pow,1,3*s,pow,1,3*s,pow,1,4*s,pow,1,3*s,pow,1,5*s,pow,1,3*s,pow,1,6*s,pow,1,3*b,gd,0,1*b,r,2,6*p,dws,1,0*p,pow,1,1*p,pow,1,6*p,uns,1,0*p,dws,1,0*p,pow,1,1*p,pow,1,6*p,p,2,0*s,pow,1,1*s,pow,1,3*s,pow,1,3*s,pow,1,4*s,pow,1,3*s,pow,1,5*s,pow,1,3*b,gd,0,1*b,r,3,4*p,dws,1,0*p,pow,1,1*p,pow,1,2*p,pow,1,6*p,uns,1,0*s,pow,1,1*s,pow,1,3*s,pow,1,3*s,pow,1,5*s,pow,1,3*s,dws,1,0*p,pow,1,1*p,pow,1,6*s,p,4,0*b,gd,1,0*b,r,6,3*p,dws,1,0*p,pow,1,1*p,pow,1,2*p,uns,1,0*s,pow,1,1*s,pow,1,4*s,pow,1,5*s,pow,2,4*s,dws,1,0*p,pow,1,1*p,pow,1,5*s,p,3,0*b,gd,1,0*b,r,4,4*p,dws,1,0*p,pow,1,1*p,pow,1,2*p,p,3,0*s,pow,1,1*s,pow,1,3*s,pow,1,5*s,pow,2,3*s,dws,1,0*s,p,4,0*b,gd,1,0*b,r,1,3*p,dws,1,0*p,pow,1,2*p,uns,1,0*p,dws,1,0*p,pow,1,2*p,p,1,0*s,pow,1,1*s,pow,1,4*s,pow,1,5*b,gd,0,1*b,r,2,4*p,dws,1,0*p,uns,1,0*p,dws,1,0*p,p,2,0*s,pow,1,1*s,pow,1,5*s,pfd,0,4*b,gd,0,1*b,r,5,1*s,dws,1,0*p,pow,1,1*p,pow,1,3*s,p,1,0*b,gd,1,0*b,r,6,6*p,dws,1,0*p,pow,1,2*p,p,1,0*b,gd,0,1*b,r,4,1*p,dws,1,0*p,pow,1,2*p,p,1,0*b,gd,0,1*b,r,3,4*s,dws,1,0*s,p,5,0*b,gd,1,0*b,r,5,3*s,dws,1,0*s,p,5,0*b,gd,1,0*b,r,6,4*p,dws,1,0*p,p,2,0*b,gd,0,1*p,1w,0,0");
        //
